 ...
 *
 * BUGFIX (this session): previous version of this file dropped the trailing
 * `data class ChatMessage(...)` that used to live at the bottom of this same
 * file — it broke the build with "Unresolved reference: ChatMessage" in both
 * this file and ChatAdapter.kt, which depends on it. Restored below, in its
 * original location/package (com.jarvismini, same file, no import needed).
 */
